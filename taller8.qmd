...
4. Resolver el sistema de ecuaciones usando Python, para un vector de demandas/aportes $b = [0, -5, 0, 0, 5]$ (es decir, el nodo B tiene una demanda de 5 l/s y el nodo E un aporte de 5 l/s).
