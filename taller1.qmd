...
Encuentra el vector $\mathbf{u}$  para que obtenga la igualdad de Cauchy–Schwarz, es decir, que se cumpla que $|\mathbf{u}\cdot\mathbf{v}| = \|\mathbf{u}\| \|\mathbf{v}\|$, justifica tu respuesta.
